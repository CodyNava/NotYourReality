                ...
                if (Physics.Raycast(currentPosition, currentDirection, out var hit, beamLength))
                {
                    ...
                    switch (hit.collider.tag)
                    {
                        ...
                        case "Skull":
                            ...
                            _skull.Reached = _skull.HasReached(_skull.transform.rotation, Quaternion.LookRotation(currentDirection));
                            
                            if (_skull.Reached)
                            {
                                _skull.transform.rotation = Quaternion.LookRotation(currentDirection);
                            }
                            else
                            {
                            ...
                            _skull.remainingReflections = reflections - i;

...
namespace Puzzle.Switch_Sequence
{
   public class SwitchSequence : MonoBehaviour
   {
      ...
      [SerializeField] private List<SequenceSwitch> sequenceOrder;
      [SerializeField] private bool toggleDoor;
      [SerializeField] private bool toggleObject;
      private List<SequenceSwitch> _playerOrder;
      private bool _hasWon;
      private Collider _collider;

      private void Awake()
      {
         _playerOrder = new List<SequenceSwitch>();
         if (!toggleDoor) return;
         _collider = GetComponent<Collider>();
         _collider.enabled = false;
      }

      public void AddSwitch(SequenceSwitch sequenceSwitch)
      {
